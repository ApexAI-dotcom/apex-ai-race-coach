            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`text-sm font-medium transition-all ${
                  (item as any).isHero
                    ? "gradient-primary text-primary-foreground px-4 py-1.5 rounded-full shadow-lg shadow-primary/30 hover:shadow-xl hover:scale-105 active:scale-100 animate-pulse"
                    ...
                    {navItems.map((item) => (
                      <Link
                        ...
                        className={`flex items-center justify-between p-4 rounded-2xl transition-all active:scale-95 ${
                          (item as any).isHero
                            ? "gradient-primary text-primary-foreground font-bold shadow-lg shadow-primary/20 animate-pulse"
                            : location.pathname === item.path

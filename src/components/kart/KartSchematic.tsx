...
export const KartSchematic = ({ profile, recent_sessions }: KartSchematicProps) => {
  ...
  const latestExhaustTemp = recent_sessions?.length
    ? Math.max(
        ...recent_sessions
          .filter((s) => s.exhaust_temp_max != null)
          .map((s) => s.exhaust_temp_max || 0)
      )
    : 0;
  ...
  const getStatusColor = (
    ...
    if (isVoltage) {
      ...
      if (current < 11.5)
        return "text-red-500 stroke-red-500 drop-shadow-[0_0_12px_rgba(239,68,68,1)] animate-pulse";
      if (current < 12.0)
        return "text-orange-500 stroke-orange-500 drop-shadow-[0_0_8px_rgba(249,115,22,0.8)]";
      return "text-green-500 stroke-green-500 drop-shadow-[0_0_8px_rgba(34,197,94,0.6)]";
    }

    if (current === undefined || max === undefined)
      return "text-muted-foreground stroke-muted-foreground/50";
      ...
      <div className="relative w-full max-w-[350px] mx-auto aspect-[2/3] flex items-center justify-center p-0">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-80 hover:opacity-100 transition-opacity duration-700 pointer-events-none">
          ...
          >
            ...
            {/* Center Floor Pan */}
            <path
              d="M 150 200 L 250 200 L 230 460 L 170 460 Z"
              fill="rgba(255,255,255,0.02)"
              stroke="none"
            />
            {/* Under-chassis tubes */}
            <path
              d="M 160 180 L 140 440 M 240 180 L 260 440"
              fill="none"
              stroke="url(#tubes)"
              strokeWidth="6"
              strokeLinecap="round"
            />
            <path
              d="M 120 220 L 280 220 M 130 380 L 270 380"
              fill="none"
              stroke="url(#tubes)"
              strokeWidth="5"
              strokeLinecap="round"
            ...
            <g transform="translate(255, 230)">
              ...
              />
              <path
                d="M 10 10 L 35 10 M 10 20 L 35 20 M 10 30 L 35 30"
                stroke="#444"
                strokeWidth="2"
                strokeLinecap="round"
              />
              ...
              <path
                d="M 40 40 Q 60 40 60 0 Q 60 -40 30 -60"
                fill="none"
                stroke={isExhaustHot ? "#220000" : "#222"}
                strokeWidth="14"
                strokeLinecap="round"
              />
              <path
                d="M 40 40 Q 60 40 60 0 Q 60 -40 30 -60"
                fill="none"
                stroke={isExhaustHot ? "#ff3333" : "#888"}
                strokeWidth="8"
                strokeLinecap="round"
                className={isExhaustHot ? "animate-pulse" : ""}
              />
              <path
                d="M 40 40 Q 60 40 60 0 Q 60 -40 30 -60"
                fill="none"
                stroke={isExhaustHot ? "rgba(255,100,50,0.6)" : "rgba(255,255,255,0.3)"}
                strokeWidth="2"
                strokeLinecap="round"
              />
            </g>
            ...
            <g transform="translate(60, 130)">
              ...
              <rect
                ...
                height="80"
                rx="8"
                fill="url(#tireGradFront)"
                stroke="#333"
                strokeWidth="2"
              />
              <path
                d="M 5 10 L 40 10 M 5 40 L 40 40 M 5 70 L 40 70"
                stroke="#111"
                strokeWidth="1"
                opacity="0.5"
              />
            ...
            <path
              d="M 70 230 C 50 250 50 380 75 420 C 100 420 115 390 125 350 C 130 310 120 230 105 230 Z"
              fill="url(#podGrad)"
              stroke="rgba(255,255,255,0.2)"
              strokeWidth="2"
            />
            <path
              d="M 85 240 C 65 260 65 370 85 400"
              fill="none"
              stroke="rgba(255,255,255,0.05)"
              strokeWidth="4"
            />
            <path
              d="M 330 230 C 350 250 350 380 325 420 C 300 420 285 390 275 350 C 270 310 280 230 295 230 Z"
              fill="url(#podGrad)"
              stroke="rgba(255,255,255,0.2)"
              strokeWidth="2"
            />
            <path
              d="M 315 240 C 335 260 335 370 315 400"
              fill="none"
              stroke="rgba(255,255,255,0.05)"
              strokeWidth="4"
            />
            ...
            <path
              d="M 155 260 C 150 160 250 160 245 260 C 240 320 230 350 200 350 C 170 350 160 320 155 260 Z"
              fill="url(#seatGlow)"
              stroke="#555"
              strokeWidth="3"
            />
            {/* Seat Inner Cushion */}
            <path
              d="M 165 260 C 160 190 240 190 235 260 C 230 300 220 330 200 330 C 180 330 170 300 165 260 Z"
              fill="#151515"
              stroke="rgba(255,255,255,0.05)"
              strokeWidth="2"
            />
            ...
            <path
              d="M 175 420 C 160 350 175 290 200 290 C 225 290 240 350 225 420 C 215 450 185 450 175 420 Z"
              fill="url(#nassauGrad)"
            ...
            <path
              d="M 185 360 C 190 380 210 380 215 360"
              fill="none"
            ...
            <path
              d="M 110 440 C 150 490 250 490 290 440 C 295 440 295 470 260 490 C 220 510 180 510 140 490 C 105 470 105 440 110 440 Z"
              fill="#151515"
              stroke="rgba(255,255,255,0.2)"
              strokeWidth="2"
            />
            ...
            <path
              d="M 120 445 C 160 475 240 475 280 445"
              fill="none"
              stroke="url(#tubes)"
              strokeWidth="6"
              strokeLinecap="round"
            ...
            <g transform="translate(68, 395)">
              ...
              />
              <path
                d="M 5 10 L 30 10 M 5 30 L 30 30 M 5 50 L 30 50"
                stroke="#111"
                strokeWidth="1"
                opacity="0.5"
              />
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[69.4%] top-[44.2%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center group cursor-pointer z-10 transition-transform hover:scale-110 hover:z-20"
            >
              <div
                className={cn(
          ...
          <TooltipContent side="right" className="bg-black/90 border-white/10 text-white">
            <p className="font-bold uppercase tracking-wider text-xs">
              Moteur ({profile.engine_model || "NC"})
            </p>
            <p className="text-sm font-mono mt-1 text-muted-foreground">
              {profile.engine_hours_current?.toFixed(1) || 0}h / {profile.engine_hours_life}h limit
            </p>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[21.4%] top-[71.2%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center group cursor-pointer z-10 transition-transform hover:scale-110"
            >
              <div
                className={cn(
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[78.6%] top-[71.2%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center group cursor-pointer z-10 transition-transform hover:scale-110"
            >
              <div
                className={cn(
                  "w-10 h-14 bg-black/60 backdrop-blur-md rounded-xl border border-white/20 flex items-center justify-center shadow-lg",
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[20.6%] top-[28.3%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center group cursor-pointer z-10 transition-transform hover:scale-110"
            >
              <div
                className={cn(
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[79.4%] top-[28.3%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center group cursor-pointer z-10 transition-transform hover:scale-110"
            >
              <div
                className={cn(
                  "w-12 h-16 bg-black/60 backdrop-blur-md rounded-xl border border-white/20 flex items-center justify-center shadow-lg",
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              onClick={() => setSelectedComp("brakes_front")}
              className="absolute left-[50%] top-[70.8%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center group cursor-pointer transition-transform hover:scale-110 z-10"
            >
              <div
                className={cn(
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              onClick={() => setSelectedComp("brakes_rear")}
              className="absolute left-[57.5%] top-[27.3%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center group cursor-pointer transition-transform hover:scale-110 z-10"
            >
              <div
                className={cn(
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              className="absolute left-[36.9%] top-[42.9%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center transition-transform hover:scale-110 cursor-pointer z-10"
            >
              <div
                className={cn(
        ...
        <DialogContent className="bg-black/95 border-white/10 text-white sm:max-w-md backdrop-blur-xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              {selectedComp === "engine" &&
                "La gestion rigoureuse des heures moteur prévient les casses et maintient des performances optimales."}
              {selectedComp?.startsWith("tire") &&
                "La dégradation des gommes influe drastiquement sur le grip mécanique et les chronos."}
              {selectedComp?.startsWith("brakes") &&
                "L'usure des plaquettes impacte directement la puissance et la répartition de freinage."}
              {selectedComp === "battery" &&
                "Une tension faible peut causer des ratés d'allumage ou empêcher le démarrage."}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            {selectedComp === "engine" && (
              <div className="space-y-4 bg-white/5 p-4 rounded-lg border border-white/5">
                <EngineVis
                  ratio={Math.min(
                    (profile.engine_hours_current || 0) / (profile.engine_hours_life || 15),
                    1
                  )}
                />
                <p>
                  <strong>Modèle :</strong>{" "}
                  <span className="text-primary">{profile.engine_model || "Standard"}</span>
                </p>
                ...
                <div className="w-full bg-white/10 h-2 rounded-full mt-2 overflow-hidden">
                  <div
                    className={cn(
                      ...
                      (profile.engine_hours_current || 0) / (profile.engine_hours_life || 15) > 0.8
                        ? "bg-red-500"
                        : "bg-primary"
                    )}
                    style={{
                      width: `${Math.min(((profile.engine_hours_current || 0) / (profile.engine_hours_life || 15)) * 100, 100)}%`,
                    }}
                  />
                </div>
              </div>
            ...
            {selectedComp?.startsWith("brakes") && (
              <div className="space-y-4 bg-white/5 p-4 rounded-lg border border-white/5">
                ...
                <p>
                  ...
                  <span className="text-primary">{profile.brakes_model || "Standard"}</span>
                </p>
                <div className="flex justify-between items-center mt-2">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <span
                    className={cn(
                      ...
                      getStatusColor(profile.battery_voltage_last, 12.5, true).split(" ")[0]
                    )}
                  >
                    {profile.battery_voltage_last || "--"} V
                  </span>

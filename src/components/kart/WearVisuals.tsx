  ...
  return (
    <div className="w-full h-32 flex items-center justify-center">
      <svg viewBox="0 0 100 100" className={cn("w-24 h-24 transition-all duration-1000", glow)}>
        ...
        <path
          d="M 35 10 L 35 90 M 50 10 L 50 90 M 65 10 L 65 90"
          stroke="#050505"
          strokeWidth="3"
          opacity={Math.max(1 - ratio * 1.5, 0)}
          strokeDasharray="10 5"
        />
        {/* Wear Indicators / Cracks */}
        {isWorn && (
          <path
            d="M 30 25 L 45 35 M 65 60 L 50 70 M 35 75 L 45 80"
            stroke="#888"
            strokeWidth="1"
            opacity={0.6}
          />
...
export const EngineVis = ({ ratio }: WearVisProps) => {
  ...
  return (
    <div className="w-full h-32 flex items-center justify-center">
      <svg
        viewBox="0 0 100 100"
        className="w-24 h-24 transition-all duration-1000 drop-shadow-[0_0_12px_rgba(255,255,255,0.1)]"
      >
        {/* Engine Block */}
        ...
        {/* Heat Glow Overlay */}
        <path
          d="M 25 30 L 75 30 L 80 50 L 20 50 Z"
          fill="rgba(239, 68, 68, 1)"
          opacity={heatOpacity * 0.8}
          filter="blur(4px)"
        />
        {/* Spark Plug */}
  ...
  return (
    <div className="w-full h-32 flex items-center justify-center">
      <svg viewBox="0 0 100 100" className="w-24 h-24 transition-all duration-1000">
        ...
        {/* Energy Symbol */}
        <path
          d="M 55 35 L 40 55 L 50 55 L 45 75 L 60 55 L 50 55 Z"
          fill="#fff"
          opacity={isLow ? 0.3 : 0.8}
